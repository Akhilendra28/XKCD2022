...
class validate_admin
{
    ...
    public function send_mail_fun($admin_mail,$admin_otp,$admin_hash_otp){
        ...
        $this->header .= 'Reply-To: akhilofficial11@gmail.com' ."\n";
        ...
        $this->message = '
            <body style=\'background-color:rgb(238,238,238);padding-top:10px;padding-bottom:10px;text-align:center;\'>
                <div style=\'width:50%;margin:0 auto;background-color:rgb(248,248,248);padding:10px\'>
                    ...
                    <h4>OR</h4>
                    <a href=\'http://xkcd.akhilofficial11.in/admin/php/validate-admin-link.php?email='.$this->admin_mail.'&otp='.$this->admin_hash_otp.'\'><button style=\'border-radius:10px;cursor:pointer\'><h3 style=\'cursor:pointer\'>Click here to verify your OTP</h3></button></a>
                </div>
            </body>
        ';
