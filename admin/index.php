...
<div id="form-style-div">
    <h1>Only for,Admin Login!<span>Sign in to visit the Admin Dashboard</span></h1>
    <form>

        <div id="step-1">
            <div class="section"><span>1</span>Please, Enter your Login Credentials</div>
            <div class="inner-wrap">
                <label>Email Address <input type="email" name="admin_mail" id="admin_mail" placeholder="Eg- xyz11@RtCampxkcd.com" autocomplete="off" /></label>
        ...
        <div id="step-2">
            ...
            <div class="inner-wrap">
                <label>Please, Enter correct OTP  <input type="number" name="otp" id="otp" value="123456" autocomplete="off" /></label>
